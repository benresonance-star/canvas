...
# Canvas Core Phase 1 convergence — 2026-07-12

Phase 1 adds a reversible `user_note` artifact-view slice without deleting legacy project-document authority.

- `artifact.id` is canonical durable identity; card IDs and file paths remain view identity and aliases.
