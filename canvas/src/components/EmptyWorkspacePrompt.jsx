...
export function EmptyWorkspacePrompt({ onCreateProject, onRefreshProjects }) {
  return (
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
          {onRefreshProjects && (
            <button
              ...
              className="sans text-xs uppercase tracking-wider border border-border text-secondary hover:text-primary px-5 py-2.5 rounded transition"
            >
