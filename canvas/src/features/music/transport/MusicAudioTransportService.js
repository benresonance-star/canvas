...
export class MusicAudioTransportService {
  ...
  async updateBeatAgent(id, patch = {}) {
    ...
    const next = normalizeAgent({
      ...
      pocket: patch.pocket ?? current.pocket,
      pocketSchedule: patch.pocketSchedule ?? current.pocketSchedule,
...
function normalizeAgent(agent) {
  return {
    ...
    pocket: agent.pocket ?? null,
    pocketSchedule: agent.pocketSchedule ?? null,
