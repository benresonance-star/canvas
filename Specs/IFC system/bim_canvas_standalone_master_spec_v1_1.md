...
| RL height markers + datum | **Shipped (MVP)** — cross-sphere markers, singleton datum, per-marker datum-relative toggle, floating measurement tools HUD; BIM viewport only (`enableRlOptions`) |
